...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--conversation-id", default="cli-session", help="Optional conversation id"
    )
    parser.add_argument(
...
def main() -> None:
    ...
    service = build_multi_agent_service(
        settings, use_heuristic_router=args.use_heuristic_router
    )
